...
//definire tabela
@Entity(tableName = "Factura_Internationala", foreignKeys = @ForeignKey(entity = Furnizori.class,parentColumns = "ID", childColumns = "Furnizor",
        onDelete = ForeignKey.CASCADE, onUpdate = ForeignKey.CASCADE))
public class FacturaInt {
    ...
    @Ignore
        public FacturaInt(int ID, String denumireFactura, int idFurnizor, float pret, String serie, String dataScadenta, String tipFactura, String moneda) {
        this.ID = ID;
    ...
    public FacturaInt(String denumireFactura, int idFurnizor, float pret, String serie, String dataScadenta, String tipFactura, String moneda) {
        this.denumireFactura = denumireFactura;
        this.idFurnizor = idFurnizor;
        this.pret = pret;
        this.serie = serie;
